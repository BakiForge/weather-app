export function displayForecast(dailyForecast) {
    const day1 = dailyForecast[0];
    const day1HTML = document.querySelector('.day1');
    const dayOfTheWeek1 = document.querySelector('.dayOfWeek1');
    if (day1) {
    ...
    const dayOfTheWeek2 = document.querySelector('.dayOfTheWeek2');
    if (day2) {
    ...
    const dayOfTheWeek3 = document.querySelector('.dayOfTheWeek3');
    if (day3) {
    ...
    const dayOfTheWeek4 = document.querySelector('.dayOfTheWeek4');
    if (day4) {
    ...
    const dayOfTheWeek5 = document.querySelector('.dayOfTheWeek5');
    if (day5) {
...
//# sourceMappingURL=displayForecast.js.map